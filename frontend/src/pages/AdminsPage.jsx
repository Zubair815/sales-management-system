                  ...
                  <tr key={admin.id}>
                    ...
                    <td data-label="Actions" data-cell="actions">
                      <div className="flex flex-wrap items-center gap-1 justify-end md:justify-start">
                        <Link to={`/admins/${admin.id}/permissions`} className="action-btn-purple" aria-label="Manage permissions">
                          <Shield size={14} /> Permissions
                        </Link>
                        <button onClick={() => openEdit(admin)} className="action-btn-blue" aria-label="Edit admin">
                          <Edit size={14} /> Edit
                        </button>
                        <button onClick={() => toggleStatus(admin)} disabled={actionLoadingId === `toggle_${admin.id}`} className="action-btn-yellow" aria-label="Toggle admin status">
                        ...
                        <button onClick={() => { setResetTarget(admin); rst2() }} className="action-btn-green" aria-label="Reset password">
                          <Key size={14} /> Reset Pwd
                        </button>
                        <button onClick={() => setDeleteTarget(admin)} className="action-btn-red" aria-label="Delete admin">
