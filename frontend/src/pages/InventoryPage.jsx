                    ...
                    {canEdit && (
                      <td data-label="Actions" data-cell="actions">
                        <div className="flex flex-wrap gap-1 justify-end md:justify-start">
                          <button onClick={() => openEdit(item)} className="action-btn-blue" aria-label="Edit item"><Edit size={14} /> Edit</button>
                          <button onClick={() => { setStockTarget(item); rst2() }} className="action-btn-green" aria-label="Adjust stock">
                            <PlusCircle size={14} /> Adjust Stock
                          </button>
                          {canCreate && <button onClick={() => setDeleteTarget(item)} className="action-btn-red" aria-label="Delete item"><Trash2 size={14} /> Delete</button>}
                        </div>
                      </td>
                    )}
                  </tr>
